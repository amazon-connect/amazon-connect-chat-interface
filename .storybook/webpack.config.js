...
const getClientEnvironment = require('../configuration/env');
...
module.exports = (config) => {
  ...
  config.resolve =  {
    ...
    alias: {
      ...
      'connect-core': paths.appSrc + '/components/core',
      'connect-services':  paths.appSrc + '/services/',
      'connect-chat': paths.appSrc + '/components/Chat',
      ...
      },
      {
        ...
        oneOf: [
          ...
          // The preset includes JSX, Flow, and some ESnext features.
          {
            ...
            include: [paths.appSrc, paths.storybook],
